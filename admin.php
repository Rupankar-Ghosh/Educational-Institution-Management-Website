...
<head>
    ...
    <style>
        ...
        .part {
            ...
            justify-content: center;
            border-radius: 20px;
            transition: box-shadow 0.1s ease, background-color 0.2s ease-in;
        }
                ...
                <a href="add_student.php">
                    <div class="part"><b>
                            <!-- <script src="https://unpkg.com/@dotlottie/player-component@2.7.12/dist/dotlottie-player.mjs"
                                type="module"></script>
                            <dotlottie-player
                                src="https://lottie.host/85793385-e5ad-410d-8962-9fa7fabd63a9/go4LTDjedX.json"
                                background="transparent" speed="1" loop autoplay></dotlottie-player> -->
                            Add Student
                        </b></div>
                </a>
                <a href="add_teacher.php">
                    <div class="part"><b>Add Teacher</b></div>
                </a>
                <a href="add_notice.php">
                    <div class="part"><b>Add Notice</b></div>
                </a>
                <a href="add_admin.php">
                    <div class="part"><b>Add Admin</b></div>
                </a>
                <a href="view_aplications.php">
                    <div class="part"><b>Aplications</b></div>
                </a>
            </div>
